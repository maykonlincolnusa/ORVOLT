...
- `cloud/` owns persistence and management APIs; it is outside local safety decisions.
...
Keep changes incremental. New services require tests, health checks, structured logs, and documented ownership. Avoid large frameworks without a concrete justification. Preserve the safety/control/edge/cloud separation.
